        ...
        <div>
                    ...
                    <div className="container mt-5">
                     <div className="row align-items-center pt-5 justify-content-center">
                        ...
                        <div className="card bg-transparent border-0 p-5">
                            <h1 className="display-4 text-white fw-bold ">Carvago at your Service!</h1>
                            <p className="text-left text-white">Real Time and Manual Filters to get your specific car in no time.</p> 
                ...
                <div className="container">
                    ...
                    <div className="col-md-9 my-3">
                        ...
                        <DataPagination DataLength={filtered.length} loading={loading} data={filtered} />
                    </div>
                </div>
                </div>
